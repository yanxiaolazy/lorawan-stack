...
// usageTemplateWithoutGlobalFlags is the default usage message from Cobra, with
// the Global Flags section stripped away.
var usageTemplateWithoutGlobalFlags = `Usage:{{if .Runnable}}
