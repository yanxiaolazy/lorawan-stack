...
func (x *MQTTConnectionInfo) Reset() {
	*x = MQTTConnectionInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_lorawan_stack_api_mqtt_proto_msgTypes[0]
...
func (*MQTTConnectionInfo) Descriptor() ([]byte, []int) {
	return file_lorawan_stack_api_mqtt_proto_rawDescGZIP(), []int{0}
}
...
var File_lorawan_stack_api_mqtt_proto protoreflect.FileDescriptor

var file_lorawan_stack_api_mqtt_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x6c, 0x6f, 0x72, 0x61, 0x77, 0x61, 0x6e, 0x2d, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x6d, 0x71, 0x74, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e,
	...
	0x22, 0xbd, 0x03, 0x0a, 0x12, 0x4d, 0x51, 0x54, 0x54, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0xb6, 0x01, 0x0a, 0x0e, 0x70, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x24, 0x52, 0x0d, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x12, 0xd1, 0x01, 0x0a, 0x12, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x74, 0x6c, 0x73, 0x5f,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0xa2, 0x01,
	0xe2, 0xde, 0x1f, 0x10, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x54, 0x4c, 0x53, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0xfa, 0x42, 0x8a, 0x01, 0x72, 0x87, 0x01, 0x32, 0x84, 0x01, 0x5e, 0x28,
	...
	0x5e, 0x24, 0x52, 0x10, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x54, 0x6c, 0x73, 0x41, 0x64, 0x64,
...
var (
	file_lorawan_stack_api_mqtt_proto_rawDescOnce sync.Once
	file_lorawan_stack_api_mqtt_proto_rawDescData = file_lorawan_stack_api_mqtt_proto_rawDesc
)

func file_lorawan_stack_api_mqtt_proto_rawDescGZIP() []byte {
	file_lorawan_stack_api_mqtt_proto_rawDescOnce.Do(func() {
		file_lorawan_stack_api_mqtt_proto_rawDescData = protoimpl.X.CompressGZIP(file_lorawan_stack_api_mqtt_proto_rawDescData)
	})
	return file_lorawan_stack_api_mqtt_proto_rawDescData
}

var file_lorawan_stack_api_mqtt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_lorawan_stack_api_mqtt_proto_goTypes = []interface{}{
	(*MQTTConnectionInfo)(nil), // 0: ttn.lorawan.v3.MQTTConnectionInfo
}
var file_lorawan_stack_api_mqtt_proto_depIdxs = []int32{
...
func init() { file_lorawan_stack_api_mqtt_proto_init() }
func file_lorawan_stack_api_mqtt_proto_init() {
	if File_lorawan_stack_api_mqtt_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lorawan_stack_api_mqtt_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MQTTConnectionInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lorawan_stack_api_mqtt_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lorawan_stack_api_mqtt_proto_goTypes,
		DependencyIndexes: file_lorawan_stack_api_mqtt_proto_depIdxs,
		MessageInfos:      file_lorawan_stack_api_mqtt_proto_msgTypes,
	}.Build()
	File_lorawan_stack_api_mqtt_proto = out.File
	file_lorawan_stack_api_mqtt_proto_rawDesc = nil
	file_lorawan_stack_api_mqtt_proto_goTypes = nil
	file_lorawan_stack_api_mqtt_proto_depIdxs = nil
}
